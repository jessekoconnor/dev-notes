...
function findDuplicate(nums) {
    // TODO: Implement solution (Floyd's cycle detection)
}
...
test('example 1', () => {
    assertEquals(findDuplicate([1, 3, 4, 2, 2]), 2);
});

test('example 2', () => {
    assertEquals(findDuplicate([3, 1, 3, 4, 2]), 3);
});

test('example 3 - all same', () => {
    assertEquals(findDuplicate([3, 3, 3, 3, 3]), 3);
});
